<script lang="ts">
    ...
    const primaryLabel = $derived(auth.user ? 'لوحة التحكم' : 'إبدأ مجاناً');
...
<div class="min-h-screen bg-background text-foreground">
    <!-- ===== NAV ===== -->
    <header
        class="sticky top-0 z-50 border-b border-border/70 bg-background/75 backdrop-blur-md"
    >
        <nav
    ...
    <main id="top">
        ...
        <section class="relative overflow-hidden">
            ...
            >
                <div
                    class="absolute -top-32 start-1/2 size-[42rem] -translate-x-1/2 rounded-full bg-primary/15 blur-3xl dark:bg-primary/20"
                ></div>
                <div
                    class="absolute -bottom-40 -end-20 size-96 rounded-full bg-[var(--chart-4)]/10 blur-3xl"
                ></div>
            </div>

            <div
                class="mx-auto grid max-w-6xl items-center gap-12 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:gap-8 lg:py-24"
            >
                <!-- copy -->
                <div class="text-center lg:text-start">
                    ...
                    >
                        ميزان يتتبّع مصروفاتك ودخلك، يصنّفها تلقائياً، ويجيب عن
                        أسئلتك المالية — كل ذلك بالريال السعودي وبلغة عربية
                        أصيلة.
                    </p>
                ...
                <!-- visual -->
                <div
                    class="relative mx-auto w-full max-w-md animate-fade-in-up lg:mx-0"
        ...
        <section id="features" class="border-y border-border bg-muted/30">
            <div class="mx-auto max-w-6xl px-4 py-20 sm:px-6">
                <div class="mx-auto max-w-2xl text-center">
                    ...
                    >
                    <h2
                        class="mt-2 text-balance text-3xl font-bold tracking-tight sm:text-4xl"
                    >
                        كل ما تحتاجه لإدارة أموالك
                    </h2>
                    <p class="mt-4 text-pretty text-muted-foreground">
                        أدوات ذكية ومترابطة تجعل تتبّع المال بسيطاً وممتعاً —
                        دون جداول ولا تعقيد.
                    </p>
                </div>
                ...
                <div class="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {#each features as f, i}
                        ...
                        >
                            <span
                                class="flex size-11 items-center justify-center rounded-xl bg-primary/10 text-primary transition-colors group-hover:bg-primary group-hover:text-primary-foreground"
                            >
        ...
        <section id="how" class="mx-auto max-w-6xl px-4 py-20 sm:px-6">
            ...
            <div class="relative mt-14 grid gap-6 md:grid-cols-3">
                {#each steps as s, i}
                    ...
                    >
                        <span
                            class="flex size-12 items-center justify-center rounded-full bg-primary text-lg font-bold text-primary-foreground shadow-soft tabular-nums"
                        >
                            {s.n}
                        </span>
        ...
        <section id="assistant" class="border-y border-border bg-muted/30">
            <div
                class="mx-auto grid max-w-6xl items-center gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2"
            >
                <div class="text-center lg:text-start">
                    <span
                        class="inline-flex items-center gap-2 rounded-full border border-border bg-card px-3 py-1 text-xs font-medium text-primary shadow-soft"
                    >
                        <Bot class="size-3.5" />
                        المساعد المالي
                    </span>
                    ...
                    <p
                        class="mx-auto mt-4 max-w-lg text-pretty leading-relaxed text-muted-foreground lg:mx-0"
                    >
                        مساعد ذكي يفهم أسئلتك بالعربية: كم صرفت، أين توفّر، أضِف
                        معاملة، أو اكشف النفقات غير المعتادة — كأنك تتحدث مع
                        مستشار مالي شخصي.
                    </p>

                    <ul
                        class="mx-auto mt-6 max-w-md space-y-3 text-start lg:mx-0"
                    >
                        {#each ['يجيب عن أسئلتك المالية فوراً', 'يضيف المعاملات نيابةً عنك', 'يكشف النفقات غير المعتادة والرؤى'] as item}
                            <li class="flex items-center gap-3 text-sm">
                                <span
                                    class="flex size-5 shrink-0 items-center justify-center rounded-full bg-income/15 text-income"
                                >
        ...
        <section class="mx-auto max-w-6xl px-4 py-20 sm:px-6">
            <div
                class="relative overflow-hidden rounded-3xl border border-border bg-primary px-6 py-16 text-center shadow-elevated sm:px-12"
            >
                <div class="pointer-events-none absolute inset-0 opacity-25">
                    <div
                        class="absolute -top-16 start-1/4 size-72 rounded-full bg-primary-foreground/30 blur-3xl"
                    ></div>
                    <div
                        class="absolute -bottom-20 end-1/4 size-72 rounded-full bg-primary-foreground/20 blur-3xl"
                    ></div>
                </div>
                <div class="relative">
                    <h2
                        class="mx-auto max-w-2xl text-balance text-3xl font-bold tracking-tight text-primary-foreground sm:text-4xl"
                    >
                        ابدأ رحلتك نحو مالٍ أكثر وضوحاً
                    </h2>
                    <p
                        class="mx-auto mt-4 max-w-lg text-pretty text-primary-foreground/85"
                    >
        ...
        <div class="mx-auto max-w-6xl px-4 py-14 sm:px-6">
            <div class="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
                <div class="lg:col-span-1">
                    ...
                    >
                        تتبّع مصاريفك بذكاء — تطبيق عربي لإدارة الميزانية
                        الشخصية بالريال السعودي.
                    </p>
                </div>
            ...
            <div
                class="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border pt-6 text-sm text-muted-foreground sm:flex-row"
            >
