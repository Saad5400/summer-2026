...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Configuration for the finance assistant agent, including the timezone
    | used to resolve relative dates such as "today" or "this month" for
    | the current user.
    |
    */
    ...
    'assistant' => [
        ...
        'max_history_messages' => env('ASSISTANT_MAX_HISTORY', 20),
    ],
